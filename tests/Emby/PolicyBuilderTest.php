...
namespace CaptainFin\Whmcs\Tests\Emby;

use CaptainFin\Whmcs\Integrations\Emby\PolicyBuilder;
...
final class PolicyBuilderTest extends TestCase
{
    public function testActivePolicyDefaultsRemainRestrictive(): void
    {
        ...
        self::assertSame(0, $policy['SimultaneousStreamLimit']);
        self::assertArrayNotHasKey('AuthenticationProviderId', $policy);
        self::assertArrayNotHasKey('SyncPlayAccess', $policy);
    }

    public function testConfiguredTechnicalOptionsAndNativeStreamLimitAreApplied(): void
    {
        $params = [
            'configoption4' => '3',
            'configoption13' => 'on',
        ...
        self::assertSame(3, $policy['SimultaneousStreamLimit']);
    }
